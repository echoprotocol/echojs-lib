...
/*
{
    ...
    BALANCE_CLAIM: 20,
    OVERRIDE_TRANSFER: 21,
    ASSET_CLAIM_FEES: 22,
    CONTRACT_CREATE: 23,
    CONTRACT_CALL: 24,
    CONTRACT_TRANSFER: 25,
    ACCOUNT_ADDRESS_CREATE: 26,
    TRANSFER_TO_ADDRESS: 27,
    SIDECHAIN_ETH_CREATE_ADDRESS: 28,
    SIDECHAIN_ETH_APPROVE_ADDRESS: 29,
    SIDECHAIN_ETH_DEPOSIT: 30,
    SIDECHAIN_ETH_WITHDRAW: 31,
    SIDECHAIN_ETH_APPROVE_WITHDRAW: 32,
    CONTRACT_FUND_POOL: 33,
    CONTRACT_WHITELIST: 34,
    SIDECHAIN_ETH_ISSUE: 35,
    SIDECHAIN_ETH_BURN: 36,
    SIDECHAIN_ERC20_REGISTER_TOKEN: 37,
    SIDECHAIN_ERC20_DEPOSIT_TOKEN: 38,
    SIDECHAIN_ERC20_WITHDRAW_TOKEN: 39,
    SIDECHAIN_ERC20_APPROVE_TOKEN_WITHDRAW: 40,
    CONTRACT_UPDATE: 41,
}
*/
 ```
