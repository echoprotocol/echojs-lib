...
/*
{
    ...
    SIDECHAIN_ERC20_REGISTER_TOKEN = 51,
    SIDECHAIN_ERC20_DEPOSIT_TOKEN = 52,
    SIDECHAIN_ERC20_SEND_DEPOSIT_TOKEN = 53,
    SIDECHAIN_ERC20_WITHDRAW_TOKEN = 54,
    SIDECHAIN_ERC20_SEND_WITHDRAW_TOKEN = 55,
    SIDECHAIN_ERC20_APPROVE_TOKEN_WITHDRAW = 56,
    SIDECHAIN_ERC20_ISSUE = 57, // VIRTUAL
    SIDECHAIN_ERC20_BURN = 58, // VIRTUAL
    SIDECHAIN_ERC20_TRANSFER_ASSET = 59,
    SIDECHAIN_BTC_CREATE_ADDRESS = 60,
    SIDECHAIN_BTC_CREATE_INTERMEDIATE_DEPOSIT = 61,
    SIDECHAIN_BTC_INTERMEDIATE_DEPOSIT = 62,
    SIDECHAIN_BTC_DEPOSIT = 63,
    SIDECHAIN_BTC_WITHDRAW = 64,
    SIDECHAIN_BTC_AGGREGATE = 65,
    SIDECHAIN_BTC_APPROVE_AGGREGATE = 66,
    SIDECHAIN_STAKE_ETH_UPDATE = 67,
    SIDECHAIN_BTC_CREATE_STAKE_SCRIPT = 68,
    SIDECHAIN_STAKE_BTC_UPDATE = 69,
    BLOCK_REWARD = 70, // VIRTUAL
    EVM_ADDRESS_REGISTER = 71,
    DID_CREATE_OPERATION = 72,
    DID_UPDATE_OPERATION = 73,
    DID_DELETE_OPERATION = 74,
}
*/
 ```
