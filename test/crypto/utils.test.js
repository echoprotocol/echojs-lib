...
describe('Utils', () => {
	...
	describe('when we call signData', () => {
		...
		const privateKey1 = PrivateKey.fromWif('5JLi3M4H9qY3FMTyGW9TCC92ebbqNo36sUHwJqpKxvJMWN2XwbH')
		const privateKey2 = PrivateKey.fromWif('5KkYp8qdQBaRmLqLz8WVrGjzkt7E13qVcr7cpdLowgJ1mjRyDx2')
		...
		it('should return the expected result with one PrivateKey', async () => {
			...
			const result = utils.signData(buffer, [PrivateKey.fromWif('5JLi3M4H9qY3FMTyGW9TCC92ebbqNo36sUHwJqpKxvJMWN2XwbH')]);
		...
		it('should return the concatenated result with two PrivateKeys', async () => {
			...
			const buffer = Buffer.from('test', 'utf-8');
			const result = utils.signData(buffer, [PrivateKey.fromWif('5JLi3M4H9qY3FMTyGW9TCC92ebbqNo36sUHwJqpKxvJMWN2XwbH'), PrivateKey.fromWif('5KkYp8qdQBaRmLqLz8WVrGjzkt7E13qVcr7cpdLowgJ1mjRyDx2')]);
