...
/** @typedef {number | string | BigNumber} TInput */

/**
 * @abstract
 * @template {number | string} TOutput
 * @augments {Serializable<TInput, TOutput>}
 */
export default class UIntType extends Serializable {
	...
	toRaw(value) {
		...
		return this._bitsCount <= 53 ? value.toNumber() : value.toString();
	}
