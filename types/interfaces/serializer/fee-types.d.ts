...
type fee_parameters<TOperationId extends OperationId, T extends serialization> = TOperationId extends any ? [
	TOperationId,
	{
		...
		[OperationId.ACCOUNT_UPGRADE]: {
			membership_annual_fee: uint64<T>,
			membership_lifetime_fee: uint64<T>,
		},
		...
		[OperationId.CHANGE_SIDECHAIN_CONFIG]: unknown,
		[OperationId.ACCOUNT_ADDRESS_CREATE]: unknown,
		[OperationId.TRANSFER_TO_ADDRESS]: unknown,
		[OperationId.GENERATE_ETH_ADDRESS]: unknown,
		[OperationId.CREATE_ETH_ADDRESS]: unknown,
		[OperationId.DEPOSIT_ETH]: unknown,
		[OperationId.WITHDRAW_ETH]: unknown,
		[OperationId.APPROVE_WITHDRAW_ETH]: unknown,
		[OperationId.CONTRACT_FUND_POOL]: unknown,
		[OperationId.CONTRACT_WHITELIST]: unknown,
		[OperationId.SIDECHAIN_ISSUE]: unknown,
		[OperationId.SIDECHAIN_BURN]: unknown,
		[OperationId.REGISTER_ERC20_TOKEN]: unknown,
		[OperationId.DEPOSIT_ERC20_TOKEN]: unknown,
		[OperationId.WITHDRAW_ERC20_TOKEN]: unknown,
		[OperationId.APPROVE_ERC20_TOKEN_WITHDRAW]: unknown,
