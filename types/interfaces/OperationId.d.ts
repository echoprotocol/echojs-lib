...
declare enum OperationId {
	...
	SIDECHAIN_ISSUE = 46, // VIRTUAL
	SIDECHAIN_BURN = 47, // VIRTUAL
	SIDECHAIN_ERC20_REGISTER_TOKEN = 48,
	SIDECHAIN_ERC20_DEPOSIT_TOKEN = 49,
	SIDECHAIN_ERC20_SEND_DEPOSIT = 50,
	SIDECHAIN_ERC20_WITHDRAW_TOKEN = 51,
	SIDECHAIN_ERC20_SEND_WITHDRAW = 52,
	SIDECHAIN_ERC20_APPROVE_TOKEN_WITHDRAW = 53,
	SIDECHAIN_ERC20_ISSUE = 54, // VIRTUAL
	SIDECHAIN_ERC20_BURN = 55, // VIRTUAL
	SIDECHAIN_BTC_CREATE_ADDRESS = 56,
	SIDECHAIN_BTC_CREATE_INTERMEDIATE_DEPOSIT = 57,
	SIDECHAIN_BTC_INTERMEDIATE_DEPOSIT = 58,
	SIDECHAIN_BTC_DEPOSIT = 59,
	SIDECHAIN_BTC_WITHDRAW = 60,
	SIDECHAIN_BTC_AGGREGATE = 61,
	SIDECHAIN_BTC_APPROVE_AGGREGATE = 62,
	BLOCK_REWARD = 63, // VIRTUAL
}
