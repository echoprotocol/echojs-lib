...
declare enum OperationId {
	...
	SIDECHAIN_ERC20_APPROVE_TOKEN_WITHDRAW = 52,
	SIDECHAIN_ERC20_ISSUE = 53, // VIRTUAL
	SIDECHAIN_ERC20_BURN = 54, // VIRTUAL
	SIDECHAIN_BTC_CREATE_ADDRESS = 55,
	SIDECHAIN_BTC_CREATE_INTERMEDIATE_DEPOSIT = 56,
	SIDECHAIN_BTC_INTERMEDIATE_DEPOSIT = 57,
	SIDECHAIN_BTC_DEPOSIT = 58,
	SIDECHAIN_BTC_WITHDRAW = 59,
	SIDECHAIN_BTC_AGGREGATE = 60,
	SIDECHAIN_BTC_APPROVE_AGGREGATE = 61,
	BLOCK_REWARD = 62, // VIRTUAL
}
