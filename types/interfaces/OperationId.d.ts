...
declare enum OperationId {
	...
	SIDECHAIN_ERC20_WITHDRAW_TOKEN = 50,
	SIDECHAIN_ERC20_APPROVE_TOKEN_WITHDRAW = 51,
	SIDECHAIN_ERC20_ISSUE = 52, // VIRTUAL
	SIDECHAIN_ERC20_BURN = 53, // VIRTUAL
	SIDECHAIN_BTC_CREATE_ADDRESS = 54,
	SIDECHAIN_BTC_CREATE_INTERMEDIATE_DEPOSIT = 55,
	SIDECHAIN_BTC_INTERMEDIATE_DEPOSIT = 56,
	SIDECHAIN_BTC_DEPOSIT = 57,
	SIDECHAIN_BTC_WITHDRAW = 58,
	SIDECHAIN_BTC_AGGREGATE = 59,
	SIDECHAIN_BTC_APPROVE_AGGREGATE = 60,
	BLOCK_REWARD = 61, // VIRTUAL
}
