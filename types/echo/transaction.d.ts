...
import OPERATION_PROPS, { AssetAmount } from "./_operations";
...
type OPERATION_RESULT<T extends OPERATION_RESULT_VARIANT> = [T, {
	...
	[OPERATION_RESULT_VARIANT.ASSET]: AssetAmount,
}[T]];
...
export default class Transaction {
	...
	getPotentialSignatures(): Promise<{ publicKeys: Array<string>, addresses: Array<string> }>;
